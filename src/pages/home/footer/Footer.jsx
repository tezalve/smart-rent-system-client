...
const Footer = () => {
    return (
        <div className='text-white mt-5' style={{ backgroundImage: `url("https://t4.ftcdn.net/jpg/06/80/65/75/240_F_680657507_vr6geDlVbMupg9s34dyzRYPhvK2gdMok.jpg")`, backgroundAttachment: "fixed" }}>
